          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
               <li ><a href="default.php">DisasterRelief</a></li>
...
<nav class="navbar navbar-inverse">
        ...
        <div class="container">
          ...
          <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Pranav Patil</h3>
          <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Ravi Alagiya</h3>

          <H1> HackUTA Hackthon</H1>

            
              <h3><a href="http://hackuta.com/">HackUTA</a> is The University of Texas at Arlington's first ever 24-hour hackathon, hosted by UTA students. </h3>
            </h3>
